...
required=(BarWidget.qml FilterablePanel.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml Thumbnail.qml manifest.json)
...
mapfile -t source_files < <(find "$source_dir" -mindepth 1 -maxdepth 1 -printf '%f\n' | LC_ALL=C sort)
expected_source=(BarWidget.qml FilterablePanel.qml Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml Thumbnail.qml manifest.json)
...
expected_publish=(BarWidget.qml FilterablePanel.qml LICENSE Panel.qml PanelFlickable.qml README.md SectionHeading.qml Service.qml Thumbnail.qml manifest.json)
